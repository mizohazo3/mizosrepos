...
function renderTimers() {
    ...
    // Render all filtered timers without sorting
...
function renderSingleTimer(timer, insertBeforeElement = null, parentContainer = null) {
    ...
    // Use createTimerHtml instead of createHorizontalTimerCard to ensure consistency
    ...
    styleElement.textContent = `
        ...
        @media (max-width: 768px) {
            .horizontal-timer-card {
                padding: 12px 15px 12px 18px !important; /* Extra left padding for border */
