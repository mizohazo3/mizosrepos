...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['password'])) {
    if ($_POST['password'] === '123') { // Set password to 123
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['fileToUpload'])) {
    ...
    // Only generate unique filename if file exists and is different from the one being uploaded
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <footer class="footer mt-5 py-3">
        <div class="container text-center">
            <div class="row">
                <div class="col-md-6">
                    <p class="mb-0">&copy; <?php echo date('Y'); ?> MCGK.SITE</p>
                </div>
                <div class="col-md-6">
