    ...
    <div class="dropdown-content">
       ...
       // Display notifications
        foreach ($notifications as $notification) {
            ...
            echo '<a href="#" class="notification ' . $cssClass . '" data-notification-id="' . $notification['id'] . '">' . $notification['message'] . '<br><span class="date-time">' . $dateTime .' ('.$notification['notif_type'].') </span></a>';
        }
