...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
       ...
       // Display all drugs and their weighted average ratings sorted by the weighted average in descending order
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            // Decode the JSON arrays to get the counts for the drug
            $counts = json_decode($row['counts'], true);
            $totalReviews = array_sum($counts);  // Sum all the review counts for this drug
