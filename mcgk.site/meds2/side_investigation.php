...
foreach ($otherSusArray as $susData) {
   ...
   if(empty($sus)){
     ...
     $happenedBefore .= 'Happened before at: ('.$susDates.')<a href="side_investigation.php?id='.$ids.'&name='.$keyword.'">' . $daytime . '</a><br>';
   }
    ...
    // If the value is different from my_sus, include it in the "Other Sus" section
       ...
       if(!empty($sus)){
            ...
            $otherSus .= '<a href="side_investigation.php?id=' . $ids . '&name=' . $keyword . '" style="border-radius: 10px; padding: 5px 10px; display: inline-block; border: 2px solid black;">(' . $susDates . ') ' . $sus . '</a>, ';
